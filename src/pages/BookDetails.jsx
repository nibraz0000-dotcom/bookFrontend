  ...
  return (
    <div className="min-h-screen bg-ice-white py-8">
        <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-light-blue rounded-lg shadow-lg overflow-hidden">
                <div className="md:flex">
                    <div className="md:w-1/3 h-96 md:h-auto bg-ice-white">
                            <img 
                    ...
                    <div className="md:w-2/3 p-8">
                        <h1 className="text-4xl font-bold text-navy mb-6">{book.title}</h1>
                        
                        <div className="space-y-4">
                            <div className="border-b border-soft-blue pb-3">
                                <p className="text-lg">
                                    <strong className="text-navy">Author:</strong> 
                            ...
                            <div className="border-b border-soft-blue pb-3">
                                <p className="text-lg">
                                    <strong className="text-navy">Stock:</strong> 
                        ...
                        <div className="mt-8">
                            <Link 
                                to="/allBooks" 
                                className="inline-block bg-soft-blue text-ice-white px-6 py-2 rounded-lg hover:bg-dusty-blue hover:text-navy transition-colors duration-300"
                            >
                                ← Back to Books
                            </Link>
                        </div>
